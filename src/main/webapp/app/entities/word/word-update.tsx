  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="aitestsApp.word.home.createOrEditLabel" data-cy="WordCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? <ValidatedField name="id" required readOnly id="word-id" label="ID" validate={{ required: true }} /> : null}
              <ValidatedField
                label="Name"
                id="word-name"
                name="name"
              ...
              />
              <ValidatedField label="Value" id="word-value" name="value" data-cy="value" type="text" />
