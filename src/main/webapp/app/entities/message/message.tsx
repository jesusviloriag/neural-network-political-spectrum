          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('manualBias')}>
                  Manual Bias <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('aIBias')}>
                  A I Bias <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {messageList.map((message, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{message.text}</td>
                  <td>{message.manualBias}</td>
                  <td>{message.aIBias}</td>
