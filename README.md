# AITests - ReactJS & Spring Boot App for training and checking a statement's political spectrum placement
...
To build the final jar and optimize the aitests application for production, run:
